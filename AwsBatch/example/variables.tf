...
variable "batch_ecr_tag" {
  type        = string
  description = "The version tag for the of the batch ECR image to use."
  default     = "example-python-batch"
}
...
# Currently sends to no one, but can be used to send to multiple people.
variable "health_emails" {
  type        = list(string)
  description = "The email addresses to send health notifications to."
  default     = []
}

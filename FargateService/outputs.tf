...
output "aws_ecs_service_service_id" {
  ...
  value       = module.ecs_fargate_service.aws_ecs_service_service_id
}

output "aws_ecs_service_service_name" {
  description = "The name of the service."
  value       = module.ecs_fargate_service.aws_ecs_service_service_name
}

output "aws_ecs_service_service_cluster" {
  description = "The Amazon Resource Name (ARN) of cluster which the service runs on."
  value       = module.ecs_fargate_service.aws_ecs_service_service_cluster
}

output "aws_ecs_service_service_desired_count" {
  description = "The number of instances of the task definition"
  value       = module.ecs_fargate_service.aws_ecs_service_service_desired_count
}
...
output "ecs_tasks_sg_description" {
  ...
  value       = module.ecs_fargate_service.ecs_tasks_sg_description
}
...
output "aws_lb_lb_id" {
  ...
  value       = module.ecs_fargate_service.aws_lb_lb_id
}

output "aws_lb_lb_arn" {
  description = "The ARN of the load balancer (matches id)."
  value       = module.ecs_fargate_service.aws_lb_lb_arn
}

output "aws_lb_lb_arn_suffix" {
  description = "The ARN suffix for use with CloudWatch Metrics."
  value       = module.ecs_fargate_service.aws_lb_lb_arn_suffix
}

output "aws_lb_lb_dns_name" {
  description = "The DNS name of the load balancer."
  value       = module.ecs_fargate_service.aws_lb_lb_dns_name
}

output "aws_lb_lb_zone_id" {
  description = "The canonical hosted zone ID of the load balancer (to be used in a Route 53 Alias record)."
  value       = module.ecs_fargate_service.aws_lb_lb_zone_id
}
...
output "aws_security_group_lb_access_sg_id" {
  ...
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_id
}

output "aws_security_group_lb_access_sg_arn" {
  description = "The ARN of the security group"
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_arn
}

output "aws_security_group_lb_access_sg_vpc_id" {
  description = "The VPC ID."
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_vpc_id
}

output "aws_security_group_lb_access_sg_owner_id" {
  description = "The owner ID."
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_owner_id
}

output "aws_security_group_lb_access_sg_name" {
  description = "The name of the security group"
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_name
}

output "aws_security_group_lb_access_sg_description" {
  description = "The description of the security group"
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_description
}

output "aws_security_group_lb_access_sg_ingress" {
  description = "The ingress rules."
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_ingress
}

output "aws_security_group_lb_access_sg_egress" {
  description = "The egress rules."
  value       = module.ecs_fargate_service.aws_security_group_lb_access_sg_egress
}
...
output "lb_http_listeners_ids" {
  ...
  value       = module.ecs_fargate_service.lb_http_listeners_ids
}

output "lb_http_listeners_arns" {
  description = "List of HTTP Listeners ARNs"
  value       = module.ecs_fargate_service.lb_http_listeners_arns
}

output "lb_https_listeners_ids" {
  description = "List of HTTPS Listeners IDs"
  value       = module.ecs_fargate_service.lb_https_listeners_ids
}

output "lb_https_listeners_arns" {
  description = "List of HTTPS Listeners ARNs"
  value       = module.ecs_fargate_service.lb_https_listeners_arns
}
